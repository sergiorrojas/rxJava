...
public class CLIPerron {
    ...
    public static void main (String[] args){
        ...
        cli.filter(msg -> msg.startsWith("suma "))
                ...
                .map(operandos -> MotorPerron.generarSuma().apply(new Integer(operandos[0]), new Integer(operandos[1])))
        ...
        cli.filter(msg -> msg.startsWith("resta "))
                ...
                .map(comando -> comando.split(" "))
                .map(operandos -> MotorPerron.generarResta().apply(new Integer(operandos[1]), new Integer(operandos[0])))
        ...
        cli.filter(msg -> msg.startsWith("imprime "))
                ...
                .map(comando -> comando.split(" "))
                .map(operandos -> MotorPerron.generarImprime().apply(operandos[0]))
        ...
        cli.filter(msg -> msg.startsWith("hora"))
                ...
                .map(operandos -> MotorPerron.generarHora().apply(operandos))
